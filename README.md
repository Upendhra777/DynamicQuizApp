🧠 Dynamic Quiz Application with Timer & Result Analysis
  ...
  This project allows users to take quizzes based on category and difficulty level, tracks time per question, 
  and shows a detailed performance analysis at the end — all without using any backend or database.
...
If you want, I can also:
  Shorten this for campus submissions
  Rewrite it in interview-friendly language
  Add screenshots section
  Optimize it for recruiters / GitHub stars
